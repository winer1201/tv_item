...
<div class="page-list" id="page_content">
    <div class="exam-form-bg" style="background:url(/app/Home/Public/img/exam/exam_bloodtrends.png);padding:0px;height:486px;">
