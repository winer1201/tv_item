...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/my/message?usercode=1010000101160829112523853&amp;user_session=10100001-a1e98537-3db1-42b0-9eab-7c62fc7298cd&amp;websitecode=&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160829112523853%26user_session%3D10100001-a1e98537-3db1-42b0-9eab-7c62fc7298cd%26websitecode%3D%26navcode%3DCM20160815001%26focusid%3Dtd2%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15008%252F%253Fexit%253D1&amp;_v=87017';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<!--
        <div style="margin-left:80px; margin-top:30px;">
            <table style="width:450px; height:40px; font-size:20px; border-right:1px #999 solid;">
                <tr>
                    <td id="td0" data-down="td1">
                        <div class="tile" style="width:410px; height:33px; text-align:center; line-height:33px;">2015-03-28&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;【系统消息】 XXXX消息</div>
                    </td>
                </tr>
                <tr>
                    <td id="td1" data-down="td2" data-up="td0">
        ...
        <div id="mov">
            <table style="width:650px; float:right; height:550px; border:1px #999 solid; margin-top:-552px; margin-right:70px; background-color:#FFF; opacity: 0.5;">
                <tr>
                    <td style="text-align:center; height:50px;"><h1>登陆送鸡蛋</h1></td>
                </tr>
                <tr>
                    <td style="height:50px;"><h2 style="margin-left:30px;">活动时间：2014年4月1日————2014年6月1日</h2></td>
                </tr>
                <tr>
                    <td style="height:50px;"><h2 style="margin-left:30px;">活动详情：</h2><span style="font-size:18px; color:525252; margin-left:30px;">1.凭兑换码可以去以下地址领取1枚鸡蛋<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址1：XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</span></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
