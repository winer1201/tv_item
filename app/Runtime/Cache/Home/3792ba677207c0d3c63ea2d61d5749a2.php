...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/exam/exercise?usercode=1010000101160830023804069&amp;user_session=10100001-5a6f1d44-e64f-40e8-8ba8-a49e8dc262cb&amp;websitecode=WS20160912001&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160830023804069%26user_session%3D10100001-5a6f1d44-e64f-40e8-8ba8-a49e8dc262cb%26websitecode%3DWS20160912001%26navcode%3DCM20160912001%26focusid%3Dtd4%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15010%252Findex%252Fshowpage%253Fusercode%253D1010000101160830023804069%2526user_session%253D10100001-5a6f1d44-e64f-40e8-8ba8-a49e8dc262cb%2526websitecode%253D%2526navcode%253DCM20160912002%2526focusid%253Dtd1%2526backUrl%253Dhttp%25253A%25252F%25252F10.10.20.11%25253A15008%25252F%25253Fexit%25253D1&amp;_v=81473';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/exam/exam_exercise','js');?>
...
<div class="page-list-title">
    <div class="list-title" id="page-title">
        <label id="lbltitle">健康档案 - 运动量</label>
    </div>
</div>
<div class="page-list" id="page_content">
    <div class="exam-form-bg" style="background:url(/app/Home/Public/img/exam/exam_bg.png);padding:0px;">
        <div class="exam-from-col">
            <label class="exam-from-col-label">本段时间内，您总共测量了149次运动量，其中：</label>
        </div>
        <div class="exam-from-col">
            <label class="exam-from-col-label">运动量正常：</label>
            <label class="exam-form-label-green">88次</label>
            <label class="exam-from-col-label">，偏少：</label>
            <label class="exam-form-label-red">51次</label>
        </div>
        <div class="exam-from-col">
