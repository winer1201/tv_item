...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/exam/bloodsugar_data?usercode=1010000101160922042001323&amp;user_session=10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4&amp;websitecode=WS20160912001&amp;areacode=10100001&amp;newreach_token=7bfc56595c55411bb25e138a4a97aad9&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160922042001323%26user_session%3D10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4%26websitecode%3DWS20160912001%26navcode%3DCM20160912001%26focusid%3Dtd1%26pian%3D110%26newreach_token%3D7bfc56595c55411bb25e138a4a97aad9%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15010%252Findex%252Fshowpage%253Fusercode%253D1010000101160922042001323%2526user_session%253D10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4%2526websitecode%253D%2526navcode%253DCM20160815002%2526focusid%253Dtd4%2526pian%253D118%2526backUrl%253Dhttp%25253A%25252F%25252F10.10.20.11%25253A15008%25252F%25253Fexit%25253D1&amp;_v=10218';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/exam/exam_bloodsugar_data','js');?>
...
<div class="page-list-title">
    <div class="list-title" id="page-title">
        <label class="exam-form-title" id="lbltitle">健康档案 - 血糖历史数据</label>
    </div>
</div>
        ...
        <table class="exam-form-table" >
            <thead style="background-color:#132037;">
                <tr >
                    ...
                    <th style="width:193px;">
                        <label>餐后血糖（毫摩尔/升）</label>
                        <br />
                        <label>3.9～7.79</label>
                    </th>
                    <th style="width:193px;">
                        <label>空腹血糖（毫摩尔/升）</label>
                        <br />
                        <label>3.9～6.09</label>
                    </th>
                    <th style="width:193px;">
                        <label>结果</label>
                    </th>
