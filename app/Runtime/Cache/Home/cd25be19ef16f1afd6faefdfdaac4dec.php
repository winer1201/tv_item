...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/exam/exam_temperature_data','js');?>
...
<div class="page-list-title">
    <div class="list-title" id="page-title">
        <label class="exam-form-title" id="lbltitle">健康档案 - 体温历史数据</label>
    </div>
</div>
