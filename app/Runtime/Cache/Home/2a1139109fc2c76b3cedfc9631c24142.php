...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/my?usercode=1010000101160830023804069&amp;user_session=10100001-59001ed1-93b6-4c31-9e24-a16c5f667c9c&amp;websitecode=&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160830023804069%26user_session%3D10100001-59001ed1-93b6-4c31-9e24-a16c5f667c9c%26websitecode%3D%26navcode%3DCM20160815001%26focusid%3Dtd1%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15008%252F%253Fexit%253D1&amp;_v=38862';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<div class="page-addcard">
    <div class="form-item" style="height:100%">
        <div class="item-1" style="width:355px;height:100%;margin-top:55px;position:relative;">
            ...
            <div style="position:absolute;top:402px;left:120px;border-radius: 5px;">
            	扫一扫二维码，完善个人信息
            </div>	
        </div>
        <div class="item-2" style="margin-top:55px;">
            ...
            <div class="form-item form1"style="position:relative;">
            	<span class="name">张国玉</span>
                <div class="item-1 title1">
            ...
            <div class="form-item form1"style="position:relative;">
            	<span class="phone">13704836423</span>
            	<script type="text/javascript">
            ...
            <div class="form-item form1"style="display:none;">
                <div class="item-1 title1">
                    <label>家庭住址：</label>
                </div>
