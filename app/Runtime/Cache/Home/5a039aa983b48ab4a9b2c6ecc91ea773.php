...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/exam/temperature?newreach_token=7bfc56595c55411bb25e138a4a97aad9&amp;usercode=1010000101160922042001323&amp;areacode=10100001&amp;user_session=10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4&amp;websitecode=WS20160912001&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160922042001323%26user_session%3D10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4%26websitecode%3DWS20160912001%26navcode%3DCM20160912001%26focusid%3Dtd7%26pian%3D110%26newreach_token%3D7bfc56595c55411bb25e138a4a97aad9%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15010%252Findex%252Fshowpage%253Fusercode%253D1010000101160922042001323%2526user_session%253D10100001-9e2fc436-dabc-4c56-a61a-6a690a8ef0a4%2526websitecode%253D%2526navcode%253DCM20160815002%2526focusid%253Dtd4%2526pian%253D118%2526backUrl%253Dhttp%25253A%25252F%25252F10.10.20.11%25253A15008%25252F%25253Fexit%25253D1&amp;_v=52950';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/exam/exam_temperature','js');?>
...
<div class="page-list-title">
    <div class="list-title" id="page-title">
        <label id="lbltitle">健康档案 - 体温</label>
    </div>
</div>
<div class="page-list" id="page_content">
    <div class="exam-form-bg" style="background:url(/app/Home/Public/img/exam/exam_bg.png);padding:0px;">
        <div class="exam-from-col">
            <label class="exam-from-col-label">本段时间内，您总共测量了24次体温，其中：</label>
        </div>
        <div class="exam-from-col">
            <label class="exam-from-col-label">体温正常：</label>
            <label class="exam-form-label-green">2次</label>
            <label class="exam-from-col-label">，偏低：</label>
            <label class="exam-form-label-red">19次</label>
            <label class="exam-from-col-label">，偏高：</label>
