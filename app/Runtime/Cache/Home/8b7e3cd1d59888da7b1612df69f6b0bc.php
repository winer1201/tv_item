...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/accompany/accompany_order2','js');?>
...
<div class="list-category-content" id="page_content">
    <div style="float:left;margin-left:81px;" id="d1" data-right="d2">
       <img src="/app/Home/Public/img/peihu/order2_zj.png" />
    </div>
    <div style="float:left;margin-left:53px;" id="d2" data-right="d3" data-left="d1">
        <img src="/app/Home/Public/img/peihu/order2_bz.png" />
    </div>
    <div style="float:left;margin-left:53px;" id="d3" data-left="d2">
        <img src="/app/Home/Public/img/peihu/order2_zdg.png" />
    </div>
</div>
