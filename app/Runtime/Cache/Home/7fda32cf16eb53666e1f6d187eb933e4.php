...
<head>
    ...
    <script type="text/javascript">
        ...
        var m_baseUrl = '/exam/bloodsugar?newreach_token=2d3c541d02ae434b897e4926c342ba7e&amp;usercode=1010000101160922042001323&amp;areacode=10100001&amp;user_session=10100001-7e5313e3-cd45-4cfc-bb0f-917801c47ac4&amp;websitecode=WS20160912001&amp;backUrl=http%3A%2F%2F10.10.20.11%3A15010%2Findex%2Fshowpage%3Fusercode%3D1010000101160922042001323%26user_session%3D10100001-7e5313e3-cd45-4cfc-bb0f-917801c47ac4%26websitecode%3DWS20160912001%26navcode%3DCM20160912001%26focusid%3Dtd1%26pian%3D110%26newreach_token%3D2d3c541d02ae434b897e4926c342ba7e%26backUrl%3Dhttp%253A%252F%252F10.10.20.11%253A15010%252Findex%252Fshowpage%253Fusercode%253D1010000101160922042001323%2526user_session%253D10100001-7e5313e3-cd45-4cfc-bb0f-917801c47ac4%2526websitecode%253D%2526navcode%253DCM20160815002%2526focusid%253Dtd4%2526pian%253D110%2526backUrl%253Dhttp%25253A%25252F%25252F10.10.20.11%25253A15008%25252F%25253Fexit%25253D1&amp;_v=10799';
        var m_rootUrl = '';
        var m_usercode = '';
        var m_user_session = '';
        var m_areacode = '';
...
<body onload="init()">
    ...
    <?php echo loadfile('/app/Home/Public/js/mod/exam/exam_bloodsugar','js');?>
...
<div class="page-list-title">
    <div class="list-title" id="page-title">
        <label class="exam-form-title" id="lbltitle">健康档案 - 血糖</label>
    </div>
</div>
<div class="page-list" id="page_content">
    <div class="exam-form-bg" style="background:url(/app/Home/Public/img/exam/exam_bg.png);padding:0px;">
        <div class="exam-from-col">
            <label class="exam-from-col-label">本段时间内，您总共测量了38次血糖，其中：</label>
        </div>
        <div class="exam-from-col">
            <label class="exam-from-col-label">血糖正常</label>
            <label class="exam-form-label-green">19次</label>
            <label class="exam-from-col-label">，高血糖：</label>
            <label class="exam-form-label-red">2次</label>
            <label class="exam-from-col-label">，空腹血糖受损：</label>
            <label class="exam-form-label-red">0次</label>
            <label class="exam-from-col-label">，糖耐量减低：</label>
            <label class="exam-form-label-red">2次</label>
            <label class="exam-from-col-label">，低血糖：</label>
        ...
        <div class="exam-from-col">
            <label class="exam-from-col-label">研究表明，血糖值对糖尿病影响很大，根据您的血糖情况预测，目前您患糖尿病的风险等级是：</label>
            <img src="../../app/home/Public/img/exam/exam_dfx.png" />

            <label class="exam-from-col-label">，建议您立即进行糖尿病风险评估， 可以得到更精确的评估结果和更完善的建议。</label>
        </div>
    </div>
