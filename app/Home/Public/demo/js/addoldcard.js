...
var addcard_instance = {
    ...
    dounsel:function(ctr){
        ...
        formfocusInstance.baseunsel(ctr);
    },
    onBack: function (e) {
        e.returnValue = false;

        var that = addcard_instance;
        var ctr = formfocusInstance.curCtr;
        var id = ctr.getAttribute("id");
    ...
    doEnter: function (e) {
        ...
        if(id == "btnverity")
        {
            ...
            {
                formfocusInstance.selnext(ctrPhone);
                return;
            }
            ...
            if(cardno=="" || cardno=="卡号")
            {
                formfocusInstance.selnext(ctrCard);
                return;
            }
            ...
            {
                formfocusInstance.selnext(ctrVerity);
                return;
            }
    ...
    numCounter: function () {
        ...
        {
            this.isvaling = false;
            var curid = formfocusInstance.curCtr.getAttribute("id");
            var numlbl = document.all("lblnum");
            var btnverity = document.all("btnverity");
            var ctrPhone = document.all("txtphoneno");
